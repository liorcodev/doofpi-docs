...
Instead of exposing raw HTTP method names, doofpi maps API intent to two simple verbs: **read**
and **write**.
...
`read` and `write` handlers both receive the same arguments object:
